...
{
	public class UsersBCComponentDiagram
    {
        ...
        public UsersBCComponentDiagram(C4 c4, ContainerDiagram containerDiagram)
		{
			this.c4 = c4;
		...
		{
            DomainLayer = containerDiagram.ApiRest.AddComponent("Domain Layer Users", "", "NodeJS (NestJS)");
            InterfaceLayer = containerDiagram.ApiRest.AddComponent("Interface Layer Users", "", "NodeJS (NestJS)");
            ApplicationLayer = containerDiagram.ApiRest.AddComponent("Application Layer Users", "", "NodeJS (NestJS)");
            InfrastructureLayer = containerDiagram.ApiRest.AddComponent("Infrastructure Layer Users", "", "NodeJS (NestJS)");
        }
		...
		private void CreateView() {
			string title = "Users BC Component Diagram";
