...
{
	public class LogginBCComponentDiagram
    {
        ...
        public LogginBCComponentDiagram(C4 c4, ContainerDiagram containerDiagram)
		{
			this.c4 = c4;
		...
		{
            DomainLayer = containerDiagram.ApiRest.AddComponent("Domain Layer Loggin", "", "NodeJS (NestJS)");
            InterfaceLayer = containerDiagram.ApiRest.AddComponent("Interface Layer Loggin", "", "NodeJS (NestJS)");
            ApplicationLayer = containerDiagram.ApiRest.AddComponent("Application Layer Loggin", "", "NodeJS (NestJS)");
            InfrastructureLayer = containerDiagram.ApiRest.AddComponent("Infrastructure Layer Loggin", "", "NodeJS (NestJS)");
        }
		...
		private void CreateView() {
			string title = "Loggin BC Component Diagram";
